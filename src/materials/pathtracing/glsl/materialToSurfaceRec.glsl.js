export const materialToSurfaceRecGLSL = /* glsl */`
	...
	float materialToSurfaceRecAlbedo(
		Material material, sampler2DArray attributesArray, sampler2DArray textures,
		uvec4 faceIndices, vec3 barycoord, vec2 uv,
		out SurfaceRec surfaceRec
	) {
	...
	void materialToSurfaceRecRemaining(
		Material material, sampler2DArray attributesArray, sampler2DArray textures,
		uvec4 faceIndices, vec3 barycoord, vec3 faceNormal, float side, vec2 uv,
		out SurfaceRec surfaceRec
	) {
