			...
			fragmentShader: /* glsl */`
				...
				void main() {
					...
					for ( i = 0; i < bounces; i ++ ) {
						...
						surfaceRec.isThinFilm = isinf( material.attenuationDistance ) && material.thickness == 0.0;
						surfaceRec.iorRatio = surfaceRec.isThinFilm || surfaceRec.frontFace ? 1.0 / material.ior : material.ior;
