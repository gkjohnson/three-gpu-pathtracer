...
const scale = parseFloat( urlParams.get( 'scale' ) ) || 1 / window.devicePixelRatio;
...
function animate() {
	...
	// TODO: use a delay field from WebGPUPathTracer
